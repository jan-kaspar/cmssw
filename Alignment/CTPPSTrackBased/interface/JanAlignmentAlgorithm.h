...
#ifndef Alignment_CTPPSTrackBased_JanAlignmentAlgorithm_h
#define Alignment_CTPPSTrackBased_JanAlignmentAlgorithm_h
...
class JanAlignmentAlgorithm : public AlignmentAlgorithm
{
  ...
  public:
    ...
    virtual unsigned int Solve(const std::vector<AlignmentConstraint>&, std::map<unsigned int, AlignmentResult> &results,
