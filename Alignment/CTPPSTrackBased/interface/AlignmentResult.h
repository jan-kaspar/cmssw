...
#ifndef Alignment_CTPPSTrackBased_AlignmentResult_h
#define Alignment_CTPPSTrackBased_AlignmentResult_h
...
class AlignmentResult
{
  ...
  public:
    AlignmentResult(
      double _sh_r1 = 0., double _sh_r1_e = 0.,
      double _sh_r2 = 0., double _sh_r2_e = 0.,
      double _sh_z = 0., double _sh_z_e = 0.,
      double _rot_z = 0., double _rot_z_e = 0.) :
        sh_r1(_sh_r1), sh_r1_unc(_sh_r1_e), 
        sh_r2(_sh_r2), sh_r2_unc(_sh_r2_e),
        sh_z(_sh_z), sh_z_unc(_sh_z_e),
        rot_z(_rot_z), rot_z_unc(_rot_z_e)
    {
    }
